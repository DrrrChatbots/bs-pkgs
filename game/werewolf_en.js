...
state prelude {
  ...
  forEach(players, (p, index) => {
    if p.role then later (index * 3500 + 1000) drrr.dm(p.name, "You are " + p.rname)
    else later (index * 3500 + 1000) drrr.dm(p.name, "You are werewolf, all werewolves are " + wolves)
  })
